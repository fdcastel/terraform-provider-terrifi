...
# coverage row (R-NN) in tmp/TERRIFI_IMPROVEMENT_PLAN.md that tracks porting
# it. When terrifi grows a resource, lift its block out of here into main.tf
# (or firewall-zbf.tf) and flip its R-row to ✅.
#
